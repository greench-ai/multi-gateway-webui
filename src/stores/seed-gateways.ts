// seed-gateways.ts - 12-agent fleet pre-seed
...
export const SEED_GATEWAYS: StoredGateway[] = [
  {
    id: 'kojiro',
    name: 'Kojiro ⚡',
    gatewayUrl: 'wss://kojiro.greench-ai.net/ws',
  ...
  },
  {
    id: 'fuma',
    name: 'Fuma 🔬',
    gatewayUrl: 'wss://fuma.greench-ai.net/ws',
  ...
  },
  {
    id: 'sasuke',
    name: 'Sasuke ⚔️',
    gatewayUrl: 'wss://sasuke.greench-ai.net/ws',
  ...
  },
  {
    id: 'akuma',
    name: 'Akuma 🔮',
    gatewayUrl: 'wss://akuma.greench-ai.net/ws',
  ...
  },
  {
    id: 'gohan',
    name: 'Gohan 🧠',
    gatewayUrl: 'wss://gohan.greench-ai.net/ws',
  ...
  },
  {
    id: 'naruto',
    name: 'Naruto 🍥',
    gatewayUrl: 'wss://naruto.greench.net/ws',
  ...
  },
  {
    id: 'goten',
    name: 'Goten 🐉',
    gatewayUrl: 'wss://goten.greench-ai.net/ws',
  ...
  },
  {
    id: 'akira',
    name: 'Akira 🎨',
    gatewayUrl: 'wss://akira.greench-ai.net/ws',
  ...
  },
  {
    id: 'goku',
    name: 'Goku 🐲',
    gatewayUrl: 'wss://goku.greench-ai.net/ws',
